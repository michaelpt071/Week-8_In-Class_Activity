...
>This code checks the variable "Country" against the strings in "reigons" and removes any that match from "Country."
...
military_long %>% 
  ...
  ggplot() +
  geom_boxplot(mapping = aes(x = spending,
                             y = Country)) +
  geom_point(mapping = aes(x = spending,
                           y = Country,
                           color = "orange",
                           alpha = 0.5),
             show.legend = FALSE)+
